...
<script>
  ...
  export default {
    ...
    created() {
      var that = this;
      this.$http
        .post(this.GLOBAL.rootUrl+"articles/typeid",{"userId":this.user.userId,"typeId":6})
        .then(function (response) {
          that.popular = response.data.data
        })
      this.$http
        .post(this.GLOBAL.rootUrl+"articles/typeid/time",{"userId":this.user.userId,"typeId":6})
        .then(function (response) {
          that.newest = response.data.data
        })
      this.$http
        .post(this.GLOBAL.rootUrl+"articles/typeid/comment",{"userId":this.user.userId,"typeId":6})
        .then(function (response) {
